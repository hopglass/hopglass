define(["moment", "numeral", "tablesort", "tablesort.numeric"],
  ...
  return function(config, el, router, d) {
    ...
    attributeEntry(attributes, "Airtime 2.4 GHz", showAirtime(2, 1 - dictGet(d.statistics, ["wireless", "airtime2", "free"])))
    attributeEntry(attributes, "Airtime 5 GHz", showAirtime(5, 1 - dictGet(d.statistics, ["wireless", "airtime5", "free"])))
