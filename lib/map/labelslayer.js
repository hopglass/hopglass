define(["leaflet", "rbush"],
  function (L, RBush) {
    ...
    function mapRTree(d) {
      return {
        minX: d.position.lat, minY: d.position.lng,
        maxX: d.position.lat, maxY: d.position.lng,
        label: d
      }
    }
      ...
      prepareLabels: function () {
        ...
        function nodeToRect(z) {
          return function (d) {
            ...
            return {
              minX: p.x - nodeRadius, minY: p.y - nodeRadius,
              maxX: p.x + nodeRadius, maxY: p.y + nodeRadius
            }
          }
        }
